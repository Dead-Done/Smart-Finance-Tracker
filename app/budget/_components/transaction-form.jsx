...
import { ReceiptScanner } from "../receipt-scanner/recipt-scanner";
...
export function AddTransactionForm({
  ...
  useEffect(() => {
    if (!editMode && !watch("date")) {
      setValue("date", new Date());
    }
  }, [editMode, setValue, watch]);
  ...
  useEffect(() => {
    if (transactionResult?.success && !transactionLoading) {
      ...
      // Only redirect if we have accountId, otherwise redirect to dashboard
